...
import { createCharacterAction } from "@/lib/actions/characterActions";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const result = await createCharacterAction({
        ...
        appearanceDescription: appearance.trim() || undefined,
          ...
          <div className="flex flex-wrap gap-2">
            {personalityTraits.map((trait) => (
              <Button
                ...
                type="button"
                variant={
                  selectedTraits.includes(trait) ? "primary" : "secondary"
                }
