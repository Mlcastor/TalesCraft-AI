  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white">
      ...
      <div className="relative w-full flex flex-col items-center justify-center px-4 py-24 text-center overflow-hidden">
        ...
        <div className="z-10 max-w-5xl">
          ...
          <p className="text-xl md:text-2xl mb-8 text-gray-300">
            Forge your destiny in an AI-powered, open-source text adventure where your choices shape the story
          </p>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-amber-400">Embark on a Dynamic Adventure</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-gray-800 bg-opacity-50 p-6 rounded-lg border border-gray-700 shadow-xl">
            ...
            <p className="text-gray-300">Craft a unique hero with a custom backstory, abilities, and personality traits that influence your adventure.</p>
          </div>
          ...
          <div className="bg-gray-800 bg-opacity-50 p-6 rounded-lg border border-gray-700 shadow-xl">
            ...
            <p className="text-gray-300">Experience a living narrative that adapts to your choices, creating a unique story tailored to your actions.</p>
          </div>
          ...
          <div className="bg-gray-800 bg-opacity-50 p-6 rounded-lg border border-gray-700 shadow-xl">
            ...
            <p className="text-gray-300">Journey through diverse locations filled with lore, secrets, and memorable characters waiting to be discovered.</p>
          </div>
          ...
          <div className="bg-gray-800 bg-opacity-50 p-6 rounded-lg border border-gray-700 shadow-xl">
            ...
            <p className="text-gray-300">Face foes in tactical turn-based combat where your skills, equipment, and decision-making determine victory.</p>
          </div>
          ...
          <div className="bg-gray-800 bg-opacity-50 p-6 rounded-lg border border-gray-700 shadow-xl">
            ...
            <p className="text-gray-300">Every decision matters, shaping your relationships, the world around you, and the ultimate outcome of your journey.</p>
          </div>
          ...
          <div className="bg-gray-800 bg-opacity-50 p-6 rounded-lg border border-gray-700 shadow-xl">
            ...
            <p className="text-gray-300">Grow in power and ability as you overcome challenges, unlock new skills, and collect powerful items.</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-900 py-12 px-4">
        <div className="max-w-5xl mx-auto">
          <div className="bg-gray-800 bg-opacity-50 rounded-lg border border-amber-600 p-6 shadow-lg">
            <h2 className="text-2xl font-bold mb-4 text-amber-400">Open Source Project</h2>
            <p className="text-gray-300 mb-4">
              Tales Craft AI is fully open source under the MIT license. We believe in community-driven development and welcome contributions from developers of all skill levels.
            </p>
